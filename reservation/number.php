...
function process($email)
{
	...
	$r = $conn->query("select id,email from booking where email='".$email."'");
	if (!$r) {
		echo($conn->error);
		die(500);
	}
	...
	$sqlquery = "select * from booking where `group`='".$email."' or email='".$email."'";
...
<div class="container">
	<section>
		<form class='form-horizontal' onsubmit='return validateForm()' action='number.php' method='post'>
			<div class='section'>
